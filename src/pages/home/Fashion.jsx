...
import { clothing } from "../../services/category.js";
...
const Fashion= () => {
  return (
    <section>
      ...
      >
        <h5 className="text-[2rem] font-medium">Fashion</h5>
        <div
          id="ad-cards"
        ...
        >
          ...
          {/* card */}
          {clothing.FASHION.map((item, index) => {
            console.log(item);
            return (
              <div
                key={index}
                className=" bg-white w-[100%] h-[170px]  flex rounded-[6px] shadow-lg hover:scale-[1.05] transition-transform duration-200 ease-in-out"
              >
                ...
                <div className="text w-[56%] h-[100%] p-[20px] flex flex-col justify-center gap-y-[0.5rem]">
                  ...
                  <h4 className=" font-semibold text-[1.3rem] text-purple-600">
                    {item.price}
                  </h4>
                </div>
              </div>
